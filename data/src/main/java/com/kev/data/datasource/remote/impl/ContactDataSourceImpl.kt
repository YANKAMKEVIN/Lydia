 ...
 * This class is responsible for fetching user data from the [ContactApi]
...
class ContactDataSourceImpl @Inject constructor(
     ...
     *
     * @return A [NetworkResponse] wrapping a [ContactListResponse] containing the list of contacts.
     */
